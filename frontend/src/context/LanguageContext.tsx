...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    occupancy_trend: 'Occupancy Trend (Blocked Rooms)',
    blocked_rooms: 'Blocked Rooms',
  ...
  mr: {
    ...
    occupancy_trend: 'ऑक्युपन्सी ट्रेंड (ब्लॉक केलेल्या खोल्या)',
    blocked_rooms: 'ब्लॉक केलेल्या खोल्या',
